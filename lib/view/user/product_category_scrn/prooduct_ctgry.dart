...
import '../../../controller/provider/productCategoryProv/product_category.dart';
          ...
          body: Consumer<CategoryProd>(
            builder: (context, UsersProductProv, child) {
              if (UsersProductProv.productsfetched == false) {
                ...
                if (UsersProductProv.products.isEmpty) {
                  return const Center(
                    child: Text('Oops product not found 🫤'),
                  );
                } else {
                  return ListView.builder(
                      itemCount: UsersProductProv.products.length,
                      shrinkWrap: true,
                      itemBuilder: (context, index) {
                        ProductModel currproduct =
                            UsersProductProv.products[index];
                        return InkWell(
                          onTap: () async {
